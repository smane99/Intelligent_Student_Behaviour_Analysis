...
lbl3 = tk.Label(window, text="Confirm Password",width=20  ,fg="white"  ,bg="#2a1b3d"    ,height=2 ,font=('times', 15, ' bold '))
lbl3.place(x=400, y=400)

txt3 = tk.Entry(window,width=20  ,bg="#e1fcff"  ,fg="black",font=('times', 15, ' bold ')  )
txt3.place(x=700, y=400,width=200,height=50)


lbl4 = tk.Label(window, text="Notification : ",width=20  ,fg="white"  ,bg="#2a1b3d"  ,height=2 ,font=('times', 15, ' bold '))
lbl4.place(x=400, y=500)
...
def add():
    ...
    Password=txt2.get()
    if Username=="":
        me="please enter username"
        message.configure(text=me)
    elif Password=="":
        me="please eneter password"
        message.configure(text=me)
    else:
        sh=insert.ins(Username,Password)
        if sh==1:
            message.configure(text="Please Go TO Login Page")
...
#Login = tk.Button(window, text="Username",fg="white",command=imp,bg="#660066"  ,borderwidth = 10,width=20  ,height=3, activebackground = "Green" ,font=('times', 15, ' bold '))
#Login.place(x=400, y=600)
register = tk.Button(window, text="Register", command=add  ,fg="white"  ,bg="#660066",borderwidth = 10,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
register.place(x=700, y=600)
