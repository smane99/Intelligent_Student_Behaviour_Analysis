...
class analysis:
    ...
    # Initialise models
    def __init__(self):
        self.emotion_model = load_model('/home/shubham/Desktop/FINAL/distractionModel/util/model/emotion_recognition.h5')
        self.detector = dlib.get_frontal_face_detector()
        self.predictor = dlib.shape_predictor(
            '/home/shubham/Desktop/FINAL/distractionModel/util/model/shape_predictor_68_face_landmarks.dat')
        self.faceCascade = cv2.CascadeClassifier(
            '/home/shubham/Desktop/FINAL/distractionModel/util/model/haarcascade_frontalface_default.xml')
        self.x = 0
        self.y = 0
        self.emotion = 5
        self.size1 = 0.0
...
# Main function for analysis
    ...
    def detect_face(self, frame):
        ...
        for face in faces:
            ...
            self.size1 = left_eye_ratio
            self.h=left_eye_ratio
...
# Downleft	2	1.5	0
        ...
        if self.h < 0.2:
            gaze_weights = 0
        elif self.size1 > 0.2 and self.size1 < 0.3:
            gaze_weights = 1.5
        else:
